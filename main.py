...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Student Managemant System")
...
class DeleteDialog(QDialog):
    ...
    def delete_student(self):
        # get selected rod index and student id
        ...
        confiration_widget = QMessageBox()
...
class EditDialog(QDialog):
    ...
    def update_student(self):
        ...
        cursor.execute("update students set name = ?, course = ?, mobile = ? where id = ?", (self.student_name.text(),
                        self.course_name.currentText(), self.mobile.text(), self.student_id))
        connect.commit()
        cursor.close()
        connect.close()
        #refresh the table
